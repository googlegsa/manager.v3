...
public class SessionPair<A extends SessionObject, D extends SessionObject>
  ...
  // "car" and "cdr" are the traditional Lisp names for the parts of a pair.
  ...
  public A getFirst() {
    return getObject(FIRST_KEY);
  }

  public void setFirst(A first) {
    setObject(FIRST_KEY, first);
  }

  public D getSecond() {
    return getObject(SECOND_KEY);
  }

  public void setSecond(D second) {
    setObject(SECOND_KEY, second);
  }
}
