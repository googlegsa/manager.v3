...
import com.google.enterprise.connector.common.HttpTransport;
...
public final class MockHttpTransport implements HttpTransport {
  ...
  private void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    ServletTestUtil.finalizeRequest(request);
  ...
  private void logRequest(HttpServletRequest request, String tag) throws IOException {
    LOGGER.log(Level.INFO, "Request: " + ServletTestUtil.servletRequestToString(request, tag));
  }

  private void logResponse(HttpServletResponse response, String tag) throws IOException {
    LOGGER.log(Level.INFO,
               "Response: " + ServletTestUtil.servletResponseToString((MockHttpServletResponse) response, tag));
  }
}
