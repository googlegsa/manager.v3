...
public class SamlAuthz extends ServletBase implements PostableHttpServlet {
  ...
  private void authorize(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    HttpServletResponseAdapter httpServletResponseAdapter = new HttpServletResponseAdapter(resp, true);
