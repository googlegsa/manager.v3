...
public final class OpenSamlUtil {
  ...
  /**
   * The SAML <code>Issuer</code> value for messages generated by this software.
   * This is supposed to be a URI, and is supposed to be different for every instance of the
   * security manager.
   * TODO(cph): don't use a fixed string for this purpose; the issuer must be configured.
   */
  public static final String SM_ISSUER = "http://google.com/enterprise/security-manager";
