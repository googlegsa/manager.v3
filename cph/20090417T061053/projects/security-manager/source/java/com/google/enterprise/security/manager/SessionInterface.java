...
public interface SessionInterface {
  ...
  /**
   * sets a given key to a given data value, within this session.
   ...
   *        null, a blank newValue is recorded
   */
   ...
   *         no such key has been set thus far. Returns null if key is passed
   *         null.
   */
  public abstract String getValue(String key);

  /**
   * sets a given key to a given binary value, within this session. Any
   * previous value for that key is replaced. New keys are accepted silently.
