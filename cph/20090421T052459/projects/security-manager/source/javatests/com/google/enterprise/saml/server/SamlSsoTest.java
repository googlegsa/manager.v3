...
public class SamlSsoTest extends SecurityManagerTestCase {
  ...
  private void setUpMultipleConfig() {
    ...
    new IdentityElementConfig("domain1", AuthNMechanism.FORMS_AUTH, "http://localhost/login1", g1);
    groups.add(g1);
    CredentialsGroupConfig g2 = new CredentialsGroupConfig("group2");
    new IdentityElementConfig("domain2", AuthNMechanism.FORMS_AUTH, "http://localhost/login2", g2);
    groups.add(g2);
