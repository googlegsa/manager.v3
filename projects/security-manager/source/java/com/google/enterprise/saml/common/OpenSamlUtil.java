 ...
 *
 * The overwhelming majority of the definitions here are static factory methods for OpenSAML
 * objects.
 */
// TODO(cph): add "final" modifier
public class OpenSamlUtil {
   ...
   */
  // TODO(cph): change value to "http://google.com/"
  ...
  /**
   * Static factory for OpenSAML <code>ArtifactResolutionService</code> objects.
   *
   ...
   * @param binding The SAML binding implemented by this service.
   * @param location The URL that the service listens to.
   * @param responseLocation The URL that the service should send responses to.
   * @return A new <code>ArtifactResolutionService</code> object.
   */
  // TODO(cph): unused, delete
  public static ArtifactResolutionService makeArtifactResolutionService(String binding,
   ...
   */
  // TODO(cph): change type of request to ArtifactResolve
  // TODO(cph): overload to allow response without message
  ...
  /**
   * Static factory for OpenSAML <code>AuthzService</code> objects.
   *
   * @param binding The SAML binding implemented by this service.
   * @param location The URL that the service listens to.
  ...
  /**
   * Static factory for OpenSAML <code>SingleSignOnService</code> objects.
   *
   * @param binding The SAML binding implemented by this service.
   * @param location The URL that the service listens to.
  ...
  /**
   * Static factory for OpenSAML artifact objects.
   *
   * @param requestContext An OpenSAML message-context object.
