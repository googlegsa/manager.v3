...
/**
 * The Connector Manager Command Processor.  This is the main entry point
 ...
 * <p>
 * <p>
 * For historical reasons, invoking this with no command and no options
 * dumps the Version info from the Manifest for the Connector Manager's JAR
 * file, as if it had been run while supplying the {@code --version} option.
 */
public class ManagerMain extends AbstractCommandLineApp {
  ...
  /**
   * Construct a new ManagerMain, preserving the original args.
   */
  public ManagerMain(String[] args) {
  ...
  public static void main(String[] args) throws Exception {
    ManagerMain app = new ManagerMain(args);
