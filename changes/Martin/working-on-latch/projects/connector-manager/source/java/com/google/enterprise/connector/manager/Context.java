...
public class Context {
  ...
  public Map getConnectorManagerConfig() {
    // TODO Auto-generated method stub
    // Figure out what keys to use.  Don't want to refer to Servlet package here
    // so need to put the keys somewhere both packages uses.  Servlet currently
    // does not use the Context class.
    return null;
  }
