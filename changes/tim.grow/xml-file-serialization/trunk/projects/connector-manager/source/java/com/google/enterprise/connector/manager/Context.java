...
public class Context {
  ...
  private static final String DEFAULT_JUNIT_CONTEXT_LOCATION =
      "testdata/mocktestdata/applicationContext.xml";
  private static final String DEFAULT_JUNIT_COMMON_DIR_PATH =
      "testdata/mocktestdata";

  private String junitContextLocation = DEFAULT_JUNIT_CONTEXT_LOCATION;
  private String junitCommonDirPath = DEFAULT_JUNIT_COMMON_DIR_PATH;
  ...
  /**
   * Sets the name of the junit context XML file used for instantiation.
   * This must be called before calling any getters.
   */
  ...
  /**
   * Sets the location of the common directory which contains ConnectorType and
   * Connector instantiation configuation data.
   */
  public void setJunitCommonDirPath(String junitCommonDirPath) {
    this.junitCommonDirPath = junitCommonDirPath;
  }
