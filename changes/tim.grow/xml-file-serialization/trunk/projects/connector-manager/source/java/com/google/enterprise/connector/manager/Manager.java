...
public interface Manager {
  ...
  /**
   * Get a ConnectorIterator which iterates over all existing connectors.
   */
  public ConnectorIterator getConnectors();

  /**
   * Replaces the existing connectors with the connectors in <code>ci</code>.
   * For each connector in <code>ci</code>, update an existing connector if the
   ...
   * <code>ci</code>.
   */
  public void setConnectors(ConnectorIterator ci)
