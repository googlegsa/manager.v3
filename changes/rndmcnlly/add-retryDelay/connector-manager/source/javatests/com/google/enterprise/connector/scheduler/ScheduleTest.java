...
public class ScheduleTest extends TestCase {
  public void testSerialization() {
    final String str = "connector1:60:1000:1-2:3-5";
    ...
    Schedule schedule = new Schedule("connector1", 60, 1000, intervals);
    Assert.assertEquals(str, schedule.toString());
    
    Schedule schedule2 = new Schedule("whatever", 30, 500, Collections.EMPTY_LIST);
