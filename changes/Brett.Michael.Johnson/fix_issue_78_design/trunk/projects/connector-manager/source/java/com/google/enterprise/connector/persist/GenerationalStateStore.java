...
public class GenerationalStateStore implements ConnectorStateStore {
  ...
  public String getConnectorState(TypeInfo typeInfo, String connectorName) {
    ...
    return baseStore.getConnectorState(typeInfo, connectorName);
  }
  ...
  public void storeConnectorState(TypeInfo typeInfo, String connectorName, 
    ...
    testGeneration(connectorName);
    baseStore.storeConnectorState(typeInfo, connectorName, connectorState);
  }
  ...
  public void removeConnectorState(TypeInfo typeInfo, String connectorName) {
    ...
    baseStore.removeConnectorState(typeInfo, connectorName);
  }
