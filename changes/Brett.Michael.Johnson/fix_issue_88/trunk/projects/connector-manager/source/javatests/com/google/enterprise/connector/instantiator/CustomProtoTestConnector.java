...
public final class CustomProtoTestConnector implements Connector {
  ...
  /* (non-Javadoc)
   * @see com.google.enterprise.connector.spi.Connector#shutdown()
   */
  public void shutdown() throws RepositoryException {
    delegateConnector.shutdown();
  }

  /* (non-Javadoc)
   * @see com.google.enterprise.connector.spi.Connector#remove()
   */
  public void remove() throws RepositoryException {
    delegateConnector.remove();
  }
}
