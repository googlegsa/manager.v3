...
public class StartUp extends HttpServlet {
  ...
  /**
   * Retrieve the Implementation-Version string from our Jar file.
   */
  private static String getJarVersion() {
    try { 
      URL url = StartUp.class.getResource(
         "/com/google/enterprise/connector/servlet/StartUp.class");
  ...
  public static void doConnectorManagerStartup(ServletContext servletContext) {
    LOGGER.info("Google Enterprise Connector Manager, version "
                + getJarVersion());
