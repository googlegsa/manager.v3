...
public final class InstanceInfo {
  ...
  private static void upgradeConfigStore(InstanceInfo info) {
    if (info.legacyConfigStores != null) {
      Iterator <ConnectorConfigStore> iter = info.legacyConfigStores.iterator();
      while (iter.hasNext()) {
        ConnectorConfigStore legacyStore = iter.next();
        Properties properties =
  ...
  private static void upgradeScheduleStore(InstanceInfo info) {
    if (info.legacyScheduleStores != null) {
      Iterator <ConnectorScheduleStore> iter =
          info.legacyScheduleStores.iterator();
      while (iter.hasNext()) {
        ConnectorScheduleStore legacyStore = iter.next();
  ...
  private static void upgradeStateStore(InstanceInfo info) {
    if (info.legacyStateStores != null) {
      Iterator <ConnectorStateStore> iter = info.legacyStateStores.iterator();
      while (iter.hasNext()) {
        ConnectorStateStore legacyStore = iter.next();
