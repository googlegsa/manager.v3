...
public class L4JXMLFormatter extends java.util.logging.SimpleFormatter {
  ...
  public String format(LogRecord record) {
    ...
    //appendAttr(buf, "thread", Integer.toString(record.getThreadID()));
   ...
   *
   * @param buf StringBuilder we are appending to.
   * @param attr The attribute name.
   * @param value The attribute value.
   */
  private void appendAttr(StringBuilder buf, String attr, String value) {
   ...
   */
  private void appendCdata(StringBuilder buf, String tag, String str) {
