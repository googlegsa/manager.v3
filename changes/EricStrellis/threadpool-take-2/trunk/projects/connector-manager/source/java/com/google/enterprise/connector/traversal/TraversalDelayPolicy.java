...
/**
 * Policy for determining how long to delay before running
 * the next batch for a connector instance.
 */
public enum TraversalDelayPolicy {
  ...
  POLL,
  /**
   * Delay appropriate for after a possibly transient error. This will
   * provide extra delay to avoid quickly hitting the problem again
