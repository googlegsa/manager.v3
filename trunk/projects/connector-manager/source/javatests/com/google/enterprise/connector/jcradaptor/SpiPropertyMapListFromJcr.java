 ...
 */
public class SpiPropertyMapListFromJcr implements
    com.google.enterprise.connector.spi.old.PropertyMapList {

  private final Node startNode;
  private final NodeIterator jcrIterator;

  public SpiPropertyMapListFromJcr(final Node thisNode, final NodeIterator nodes) {
    startNode = thisNode;
    jcrIterator = nodes;
  }

  public SpiPropertyMapListFromJcr(final NodeIterator nodes) {
    startNode = null;
    jcrIterator = nodes;
  }
